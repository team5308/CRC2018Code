...
std::shared_ptr<frc::Solenoid> RobotMap::pneumaticsSystemSolenoid2;
...
void RobotMap::init() {
    ...
    drivingSystemVictorSPX2.reset(new WPI_VictorSPX(3));
    ...
    pneumaticsSystemSolenoid1.reset(new frc::Solenoid(0, 0));
    lw->AddActuator("PneumaticsSystem", "Solenoid 1", pneumaticsSystemSolenoid1);
    
    pneumaticsSystemSolenoid2.reset(new frc::Solenoid(0, 1));
    lw->AddActuator("PneumaticsSystem", "Solenoid 2", pneumaticsSystemSolenoid2);
    
    pneumaticsSystemSolenoid3.reset(new frc::Solenoid(0, 2));
    lw->AddActuator("PneumaticsSystem", "Solenoid 3", pneumaticsSystemSolenoid3);
    
    pneumaticsSystemSolenoid4.reset(new frc::Solenoid(0, 3));
