...
std::shared_ptr<frc::Compressor> RobotMap::pneumaticsSystemCompressor;
std::shared_ptr<frc::Solenoid> RobotMap::pneumaticsSystemSolenoid1;
std::shared_ptr<frc::DoubleSolenoid> RobotMap::pneumaticsSystemSolenoid2;
std::shared_ptr<frc::Solenoid> RobotMap::pneumaticsSystemSolenoid3;
std::shared_ptr<frc::Solenoid> RobotMap::pneumaticsSystemSolenoid4;
std::shared_ptr<frc::ADXRS450_Gyro> RobotMap::Gyro1;
...
void RobotMap::init() {
    ...
    drivingSystemTalonSRX1.reset(new WPI_TalonSRX(1));
    
    
    drivingSystemVictorSPX1.reset(new WPI_VictorSPX(2));
    
    
    drivingSystemVictorSPX2.reset(new WPI_VictorSPX(3)); // intake
    
    
    drivingSystemSpeedControllerGroup1 = std::make_shared<frc::SpeedControllerGroup>(*drivingSystemTalonSRX1, *drivingSystemVictorSPX1);
    lw->AddActuator("DrivingSystem", "Speed Controller Group 1", drivingSystemSpeedControllerGroup1);
    
    drivingSystemTalonSRX2.reset(new WPI_TalonSRX(11));
    
    
    drivingSystemVictorSPX3.reset(new WPI_VictorSPX(5));
    
    
    drivingSystemVictorSPX4.reset(new WPI_VictorSPX(6));
    
    
    drivingSystemSpeedControllerGroup2 = std::make_shared<frc::SpeedControllerGroup>(*drivingSystemTalonSRX2, *drivingSystemVictorSPX3);
...
//    drivingSystemRobotDrive21.reset(new frc::RobotDrive(drivingSystemVictorSPX1, drivingSystemVictorSPX3));
    ...
    hangingSystemTalonSRX1.reset(new WPI_TalonSRX(4));
    ...
    hangingSystemSpark1.reset(new frc::Spark(9));
    lw->AddActuator("HangingSystem", "Spark1", std::static_pointer_cast<frc::Spark>(hangingSystemSpark1));
    
    hangingSystemVictorSPX1.reset(new WPI_VictorSPX(12));
    
    
    hangingSystemVictorSPX2.reset(new WPI_VictorSPX(10));
    ...
    intakeSystemSpark2.reset(new frc::Spark(6));
...
//    intakeSystemVictorSP1.reset(new frc::VictorSP(4));
//    lw->AddActuator("IntakeSystem", "VictorSP1", std::static_pointer_cast<frc::VictorSP>(intakeSystemVictorSP1));
    
//    intakeSystemVictorSP2.reset(new frc::VictorSP(5));
//    lw->AddActuator("IntakeSystem", "VictorSP2", std::static_pointer_cast<frc::VictorSP>(intakeSystemVictorSP2));
    
    pneumaticsSystemCompressor.reset(new frc::Compressor(0));
    lw->AddActuator("PneumaticsSystem", "Compressor", pneumaticsSystemCompressor);
    
    pneumaticsSystemSolenoid1.reset(new frc::Solenoid(0, 4));
    lw->AddActuator("PneumaticsSystem", "Solenoid 1", pneumaticsSystemSolenoid1);
    
    pneumaticsSystemSolenoid2.reset(new frc::DoubleSolenoid(0, 1, 2));
    lw->AddActuator("PneumaticsSystem", "Solenoid 2", pneumaticsSystemSolenoid2);
    
    pneumaticsSystemSolenoid3.reset(new frc::Solenoid(0, 6)); // 1-- forward   2
    lw->AddActuator("PneumaticsSystem", "Solenoid 3", pneumaticsSystemSolenoid3);
    
    pneumaticsSystemSolenoid4.reset(new frc::Solenoid(0, 7));
    lw->AddActuator("PneumaticsSystem", "Solenoid 4", pneumaticsSystemSolenoid4);

    Gyro1.reset(new ADXRS450_Gyro( SPI::kOnboardCS0 ));
    lw->AddSensor("Sensor", "Gyro1", Gyro1);
